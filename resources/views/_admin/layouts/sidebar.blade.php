<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4"
    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main" style="height: calc(100vh - 120px) !important;">
        <ul class="navbar-nav">
            ...
            <li class="nav-item mt-3">
                <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Akademik & Kesiswaan</h6>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('admin.letters.*') ? 'active-menu' : '' }}" href="{{ route('admin.letters.index') }}">
                    <div class="icon icon-shape border-radius-md me-2 d-flex align-items-center justify-content-center">
                        @include('icon.report')
                    </div>
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('student.letters.index') ? 'active-menu' : '' }}" href="{{ route('student.letters.index') }}">
                    <div class="icon icon-shape border-radius-md me-2 d-flex align-items-center justify-content-center">
                        @include('icon.report')
                    </div>
                    <span class="nav-link-text ms-1">Pengajuan Izin</span>
