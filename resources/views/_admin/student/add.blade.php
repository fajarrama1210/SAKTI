    ...
    <div class="container-fluid mt--6">
        <div class="card sakti-card">
            <div class="card-header border-0 bg-white">
                <h3 class="mb-0 text-sakti-green font-weight-bold">Tambah Siswa & Buat Akun</h3>
            </div>
            ...
            <div class="card-body">
                ...
                <form action="{{ route('admin.students.store') }}" method="POST">
                    ...
                    <button type="submit" class="btn btn-sakti-primary mt-3"><i class="fas fa-save mr-2"></i> Simpan Data</button>
