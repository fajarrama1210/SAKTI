...
<div class="container-fluid mt--6">
    ...
    <div class="letters-header mb-4">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 position-relative" style="z-index: 1;">
            ...
            <a href="{{ route('admin.majors.create') }}" class="btn btn-sm" style="background: rgba(255,255,255,.18); border: 1px solid rgba(255,255,255,.3); color: #fff; border-radius: 12px; font-weight: 600; backdrop-filter: blur(4px);">
