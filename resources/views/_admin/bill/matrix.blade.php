    ...
    <div class="card shadow">
        <div class="card-header border-0">
            <div class="row align-items-center">
                <div class="col">
                    <h3 class="mb-0"><i class="fas fa-th"></i> Matrix Pembayaran SPP</h3>
        ...
        <div class="card-body bg-secondary border-top border-bottom py-3">
            <form method="GET" action="{{ route('admin.spp.matrix') }}" class="row align-items-end">
                ...
                <div class="col-md-4">
                    <button type="submit" class="btn btn-sm btn-primary btn-block"><i class="fas fa-search"></i> Tampilkan Matrix</button>
                </div>
            </form>
        </div>
            ...
            <table class="table align-items-center table-flush table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        @foreach($data['months'] as $m)
                            @php
                                $bill = $data['bills']->get($student->id)?->firstWhere('month', $m['month']);
                            @endphp
            ...
            <div class="row align-items-center">
                <div class="col-md-8">
                    ...
                    <div class="d-flex flex-wrap gap-2">
                        <div class="mr-3"><span class="btn btn-sm btn-icon-only btn-success rounded-circle mr-1"><i class="fas fa-check text-white"></i></span> Lunas</div>
                ...
                <div class="col-md-4 text-right">
                    <button class="btn btn-sm btn-primary" onclick="window.print()"><i class="fas fa-print"></i> Cetak Laporan Matrix</button>
                </div>
            </div>
        </div>
        @else
...
<style>
    @media print {
        .navbar-search, .sidenav, .btn-primary, .card-header .btn, form, .card-footer .btn {
