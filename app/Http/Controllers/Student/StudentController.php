...
class StudentController extends Controller
{
    ...
    public function updateAvatar(Request $request)
    {
        ...
        // Jika FILESYSTEM_DISK=s3, gunakan S3; selainnya gunakan 'public'.
        ...
        if ($user->avatar) {
            try {
                ...
                // Juga coba hapus dari disk lain jika ada perubahan disk
                if ($disk !== 'public') {
        ...
        try {
            if ($processedFile instanceof \Illuminate\Http\File) {
                ...
                // Fallback: upload file asli tanpa kompresi
    ...
    private function resizeAndCompressAvatar($file, $maxWidth = 300, $maxHeight = 300)
    {
        ...
        // Pertahankan transparansi untuk format PNG/WebP
