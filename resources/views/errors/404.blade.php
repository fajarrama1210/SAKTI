...
<head>
    ...
    <title>Halaman Tidak Ditemukan - {{ config('app.name', 'SAKTI') }}</title>
...
<body>
    ...
    <div class="card">
        <div class="image-container">
            ...
            <img src="{{ asset('assets/img/404.webp') }}" alt="Halaman Tidak Ditemukan" class="illustration">
        </div>
        ...
        <p class="error-message">
            Maaf, halaman yang Anda cari tidak dapat ditemukan atau telah dipindahkan.<br>Silakan kembali ke halaman utama.
        </p>
