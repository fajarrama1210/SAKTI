        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 position-relative" style="z-index: 1;">
            <div>
                <h3 class="text-white font-weight-bold mb-1" style="font-size: 1.3rem; letter-spacing: -0.02em;">
                    <i class="fas fa-exchange-alt me-2"></i> Laporan Transaksi Keuangan
                </h3>
                <p class="text-white mb-0" style="opacity: .7; font-size: 0.88rem;">
                    Rekap rinci transaksi uang masuk dan uang keluar.
                </p>
            </div>
            @if($filtered && $data->count() > 0)
            <div class="d-flex gap-2">
                <a href="{{ route('admin.reports.transaction.excel', request()->query()) }}" class="btn btn-sm btn-glass btn-glass-success">
                    <i class="fas fa-file-excel me-1"></i> Excel
                </a>
                <a href="{{ route('admin.reports.transaction.pdf', request()->query()) }}" class="btn btn-sm btn-glass btn-glass-danger">
                ...
                <div class="row align-items-end">
                    <div class="col-md-5 col-sm-12 mb-3 mb-md-0">
                        ...
                        <div class="position-relative">
                            ...
                            <input type="text" name="search" class="form-control" placeholder="Keterangan, kategori, atau nama pencatat..." value="{{ $filters['search'] ?? '' }}" style="padding-left: 40px;">
                        </div>
                    </div>
