...
@push('styles')
    ...
    <style>
        ...
        .filter-pill.paid    { border-color: #c3e6cb; color: var(--primary-green); background: #f0faf5; }
        .filter-pill.paid.active, .filter-pill.paid:hover { background: var(--primary-green); color: #fff; border-color: var(--primary-green); }
        .filter-pill.partial { border-color: #fdeeba; color: #856404; background: #fffdf0; }
        .filter-pill.partial.active, .filter-pill.partial:hover { background: var(--warning-color); color: #fff; border-color: var(--warning-color); }
        .filter-pill.unpaid  { border-color: #f5c6cb; color: var(--danger-color); background: #fff5f5; }
        .filter-pill.unpaid.active, .filter-pill.unpaid:hover { background: var(--danger-color); color: #fff; border-color: var(--danger-color); }
        ...
        .spp-search-box .clear-btn:hover { color: var(--danger-color); }
        ...
        .amount-label .paid-lbl{ font-weight: 700; color: var(--primary-green); }
        .spp-progress {
        ...
        .badge-paid    { background: #e8f8f0; color: var(--primary-green); }
        .badge-partial { background: #fff8e6; color: #856404; }
        .badge-unpaid  { background: #fef0f0; color: var(--danger-color); }
    ...
    <div class="row g-3 mb-4">
        ...
        <div class="col-xl-3 col-md-6">
            <div class="summary-card sc-blue h-100">
                ...
                <div class="sc-value">Rp {{ number_format($totalAmount, 0, ',', '.') }}</div>
                <div class="mt-2" style="font-size: .78rem; font-weight: 500; color: rgba(255,255,255,.8);">
                    {{ number_format($totalBills) }} tagihan
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="summary-card sc-green h-100">
                ...
                <div class="sc-label">Terbayar</div>
                <div class="sc-value">Rp {{ number_format($totalPaid, 0, ',', '.') }}</div>
                <div class="mt-2" style="font-size: .78rem; font-weight: 500; color: rgba(255,255,255,.8);">
                    {{ $collectRate }}% dari tagihan
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="summary-card sc-red h-100">
                ...
                <div class="mt-2" style="font-size: .78rem; font-weight: 500; color: rgba(255,255,255,.8);">
                    {{ number_format($countUnpaid + $countPartial) }} tagihan tertunggak
                </div>
            </div>
        </div>
                ...
                <div class="card-body p-4">
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-2">
                        ...
                        <div class="d-flex gap-2 text-xs">
                            <span class="badge rounded-pill px-2 py-1" style="background:#e8f8f0; color:var(--primary-green);">{{ $countPaid }} Lunas</span>
                            <span class="badge rounded-pill px-2 py-1" style="background:#fff8e6; color:#856404;">{{ $countPartial }} Cicil</span>
                            <span class="badge rounded-pill px-2 py-1" style="background:#fef0f0; color:var(--danger-color);">{{ $countUnpaid }} Belum</span>
                        </div>
                    </div>
                    <div class="spp-progress">
                        <div class="spp-progress-bar"
                             style="width:{{ $collectRate }}%; background: linear-gradient(90deg, var(--primary-green), var(--secondary-green));">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <tbody>
                    ...
                    @php
                        ...
                        $barColor = match($bill->status) {
                            'paid'    => 'linear-gradient(90deg, var(--primary-green), var(--secondary-green))',
                            'partial' => 'linear-gradient(90deg, var(--warning-color), #ffd166)',
                            default   => 'linear-gradient(90deg, var(--danger-color), #ff6b81)',
                        };
