        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 position-relative" style="z-index: 1;">
            <div>
                <h3 class="text-white font-weight-bold mb-1" style="font-size: 1.3rem; letter-spacing: -0.02em;">
                    <i class="fas fa-plus-circle me-2"></i> Catat Transaksi Manual
                </h3>
                <p class="text-white mb-0" style="opacity: .7; font-size: 0.88rem;">Tambah catatan transaksi keuangan secara manual.</p>
            </div>
    ...
    <div class="sakti-form-card">
        <div class="form-card-header">
            <div class="d-flex align-items-center gap-3">
                ...
                <div><h3>Formulir Transaksi Manual</h3><p>Isi semua field yang diperlukan</p></div>
            </div>
        </div>
        <div class="form-card-body">
            ...
            <form action="{{ route('admin.transactions.store') }}" method="POST">
                ...
                <div class="form-action-bar">
                    <button type="submit" class="btn btn-sakti-primary"><i class="fas fa-save me-1"></i> Simpan Transaksi</button>
